...
#print random_int_list(1, 1000, 100000)
...
# points = random_int_list(1, 1000, 100000)
# plot_histogram(points, 10, title=u"刘志晗")
...
#
#     #显示均匀分布
#     plot_histogram(uniform, 10 ,u"均匀分布的直方图")
